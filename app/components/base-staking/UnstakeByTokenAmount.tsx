...
export const UnstakeByTokenAmount: FC = () => {
    ...
    const onClick = useCallback(async () => {
        ...
        try {
            ...
            // Calculate the amount of xTokens needed to unstake to receive the inputAmount of Tokens
